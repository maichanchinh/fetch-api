...
var createResponse = function createResponse(origResp) {
  ...
  if (_lodash2.default.isObject(origResp.headers.map)) {
    _lodash2.default.forEach(origResp.headers.map, function (pair) {
      resp[headersObj] = Object.assign({}, resp[headersObj], pair);
    });
  }
  return resp;
};
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 3:
                  ...
                  contentType = _lodash2.default.get(res.headers.map, 'Content-Type');

                  Object.defineProperty(res, 'headers_contentType', {
                    value: contentType
                  });
